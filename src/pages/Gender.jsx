...
const Gender = ({ onSelect, selectedGender, onNext, onBack }) => {
  ...
  return (
    ...
    >
      <h2 className="heading" style={{ color: "#fff", marginBottom: "2rem" }}>
        Select Your Gender
      </h2>
      ...
      >
        ...
        >
          ...
          />
          <h3 style={{ fontSize: "1.1rem" }}>Male</h3>
        </motion.div>

        {/* Female Card */}
        <motion.div
          className={`option-card ${
            localSelected === "female" ? "selected" : ""
          }`}
          style={{
            cursor: "pointer",
            // border:
        ...
        >
          ...
          <motion.img
            ...
            transition={{ duration: 0.1 }}
          />
          <h3 style={{ fontSize: "1.1rem" }}>Female</h3>
        </motion.div>
      </div>
